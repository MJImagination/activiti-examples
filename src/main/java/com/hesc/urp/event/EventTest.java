...
public class EventTest {
	...
	InputStream inbpmn =this.getClass().getResourceAsStream("Event.bpmn");
	InputStream inpng =this.getClass().getResourceAsStream("Event.png");
	Deployment deployment =	processEngine.getRepositoryService()//与流程定义和部署对象相关的service
		             .createDeployment()//创建一个部署对象
		             .name("事件流程")
		             .addInputStream("Event.bpmn", inbpmn)
		              .addInputStream("Event.png", inpng)
		             .deploy();
	...
	public void  completeMyPersonTask1() {
		...
		Map<String,Object> varibale=new HashMap<String,Object>();
		varibale.put("money", 1200);
		processEngine.getTaskService()
		             .complete(taskid, varibale);
	}
	/**完成我的任务*/
	@Test
	public void  completeMyPersonTask2() {
		String taskid="2506";
		//完成任务的同时,设置流程流程变量，使用流程变量用来指定完成后，下一个连心，对应sequenceFlow.bpmn中的${message=="不重要"}
		
		processEngine.getTaskService()
		             .complete(taskid);
		System.out.println("完成 城管");
	}
	/**完成我的任务*/
	@Test
	public void  completeMyPersonTask4() {
		String taskid="2670079";
		//完成任务的同时,设置流程流程变量，使用流程变量用来指定完成后，下一个连心，对应sequenceFlow.bpmn中的${message=="不重要"}
		String activityId="GRID72usertask311";
		Map<String,Object> varibale=new HashMap<String,Object>();
		//varibale.put("startFlow", "jdznb");
		try {
			turnTransition(taskid,activityId,varibale);
		} catch (Exception e) {
	...
	/**查询状态*/
	@Test
	public void  completeMyPersonTask3() {
	String pid="195030";
		ExecutionEntity execution = (ExecutionEntity)processEngine.getRuntimeService().createExecutionQuery().processInstanceId(pid).singleResult();
		if(execution!=null){
        ...
        if (flowElement instanceof UserTask) {  
	        ...
	        if(userTask.getId().equals(activitiId)){
	 	        List<SequenceFlow> outgoingFlows = userTask.getOutgoingFlows();
	 			for (SequenceFlow sequenceFlow : outgoingFlows) {
	 				System.out.println("==========:"+sequenceFlow.getId()+"==========:"+sequenceFlow.getName()+"========"+sequenceFlow.getTargetRef()+"----------"+sequenceFlow.getSourceRef());
     ...
     * @throws Exception 
     */  
	private void turnTransition(String taskId, String activityId,Map<String,Object> varibale ) throws Exception {  
        // 当前节点  
