package com.hesc.urp.groupUser;
...
public class personalTest {
	...
	/**添加用户角色组*/
     ...
     identityService.saveUser(new UserEntity("张三2"));
     identityService.saveUser(new UserEntity("张三3"));
     //建立用户和角色的管理关系
     identityService.createMembership("张三", "部门经理");
     identityService.createMembership("张三2", "部门经理");
     identityService.createMembership("张三3", "总经理");
